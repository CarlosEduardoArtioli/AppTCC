(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesDeviceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DeviceService = class DeviceService {
      ...
      createDevice(apt, mac) {
        // Retorna para a função um deviceListRef com um id aleatório(push) com os seguintes dados
        this.db.object("/users/".concat(this.user.email, "/dispositivos/").concat(mac)).set({
      ...
      getDevice(mac) {
        ...
        this.deviceRef = this.db.object("/users/".concat(this.user.email, "/dispositivos/").concat(mac)); // Retorna o deviceRef para a função
      ...
      getDeviceList() {
        ...
        this.deviceListRef = this.db.list("/users/".concat(this.user.email, "/dispositivos")); // Retorna o deviceListRef para a função
      ...
      deleteDevice(mac) {
        ...
        // /dispositivos/id (sendo o id passado junto a função)
        this.deviceRef = this.db.object("/users/".concat(this.user.email, "/dispositivos/").concat(mac)); // Remove o objeto que foi atribuido ao deviceRef
      ...
      mudaStatus(mac) {
        ...
        this.db.database.ref("/users/".concat(this.user.email, "/dispositivos/").concat(mac, "/status")).once('value').then(snapshot => {
          ...
          if (snapshot.val() == 'ligado') {
            ...
            this.db.database.ref("/users/".concat(this.user.email, "/dispositivos/").concat(mac, "/status")).set('desligado');
          } else {
            // Se não for, ele entra no caminho e altera o valor e muda o valor para 'on'
            this.db.database.ref("/users/".concat(this.user.email, "/dispositivos/").concat(mac, "/status")).set('ligado');
          }
        });
      }
