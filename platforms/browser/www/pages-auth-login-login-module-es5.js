      ...
      signInWithGoogle() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          .then(data => {
            ...
            localStorage.setItem('app.user', JSON.stringify(new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_6__["User"](data.user.displayName, data.user.email, data.user.photoURL))); // Navega para a página 'home'
