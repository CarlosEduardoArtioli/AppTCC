(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesDeviceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    "./node_modules/@angular/fire/database/es2015/index.js"); // Services são os "serviços" que podem ser reutilizados por todo o app
    ...
    let DeviceService = class DeviceService {
      constructor( // AngularFireDatabase é uma classe para refernciar o banco
      // Recebeu o apelido de db
      db) {
        this.db = db; // Declaração da variável status
      ...
      getDevice(mac) {
        ...
        this.deviceRef = this.db.object("/users/".concat(this.email, "/devices/").concat(mac)); // Retorna o deviceRef para a função
      ...
      getDeviceList() {
        ...
        this.deviceListRef = this.db.list("/users/".concat(this.email, "/devices")); // Retorna o deviceListRef para a função
      ...
      updateIcon(icone, nomeIcone, mac) {
        this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/icon/iconName")).set(nomeIcone);
        return this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/icon/icon")).set(icone);
      } // Função para atualizar o nome do dispositivo


      updateName(nome, mac) {
        return this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/name")).set(nome);
      } // Função para atualizar o cômodo que o dispositivo se encontra


      updateRoom(room, iconRoom, mac) {
        this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/room/name")).set(room);
        return this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/room/icon")).set(iconRoom);
      ...
      deleteDevice(mac) {
        ...
        // /dispositivos/id (sendo o id passado junto a função)
        this.deviceRef = this.db.object("/users/".concat(this.email, "/devices/").concat(mac)); // Remove o objeto que foi atribuido ao deviceRef
      ...
      mudaStatus(mac) {
        ...
        this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/status")).once('value').then(snapshot => {
          ...
          if (snapshot.val() === 'ligado') {
            ...
            this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/status")).set('desligado');
          } else {
            // Se não for, ele entra no caminho e altera o valor e muda o valor para 'on'
            this.db.database.ref("/users/".concat(this.email, "/devices/").concat(mac, "/status")).set('ligado');
          }
        });
      }
    ...
    DeviceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"]])], DeviceService);
    /***/
  },
  ...
  function srcAppServicesRoomServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let RoomService = class RoomService {
      ...
      createRoom(room, icone) {
        this.db.object("/users/".concat(this.email, "/rooms/").concat(room)).set({
      ...
      getRoom(room) {
        ...
        this.roomRef = this.db.object("/users/".concat(this.email, "/rooms/").concat(room)); // Retorna o roomRef para a função
      ...
      getRoomList() {
        ...
        this.roomListRef = this.db.list("/users/".concat(this.email, "/rooms")); // Retorna o roomListRef para a função
      ...
      updateName(nome, comodo) {
        this.db.object("/users/".concat(this.email, "/rooms/").concat(comodo, "/name")).set(nome);
      } // Função para atualizar o icone do cômodo


      updateIcon(icone, iconName, comodo) {
        this.db.object("/users/".concat(this.email, "/rooms/").concat(comodo, "/iconName")).set(iconName);
        return this.db.object("/users/".concat(this.email, "/rooms/").concat(comodo, "/icon")).set(icone);
      } // Função que exclui os dados do objeto com o cômodo passado


      deleteRoom(room) {
        // Atribui ao roomRef o objeto que foi encontrado no caminho
        this.roomRef = this.db.object("/users/".concat(this.email, "/rooms/").concat(room)); // Remove o objeto que foi atribuido ao roomRef
    ...
    RoomService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"]])], RoomService);
    /***/
  },
  ...
  /***/
  function srcAppServicesTimerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let TimerService = class TimerService {
      ...
      getTimerList(mac) {
        // Atribui ao deviceListRef a lista dos objetos encontrados no caminho
        this.timerListRef = this.db.list("/users/".concat(this.user.email, "/devices/").concat(mac, "/timer")); // Retorna o deviceListRef para a função
      ...
      getTimer(timer, mac) {
        ...
        this.timerRef = this.db.object("/users/".concat(this.user.email, "/devices/").concat(mac, "/timer/").concat(timer)); // Retorna o timerRef para a função

        return this.timerRef;
      }

      getTimerNumber(mac) {
        this.timerRef = this.db.object("/users/".concat(this.user.email, "/devices/").concat(mac, "/timernumber")); // Retorna o timerRef para a função

        return this.timerRef;
      }

      addTimerNumber(mac, timernumber) {
        this.db.object("/users/".concat(this.user.email, "/devices/").concat(mac, "/timernumber")).set(timernumber);
      } // Função que atualiza os dados do timer


      addTimer(action, dateTime, week1, week2, week3, week4, week5, week6, week7, mac, timernumber) {
        this.timerRef = this.db.object("/users/".concat(this.user.email, "/devices/").concat(mac, "/timer/timer").concat(timernumber)); // Retorna para a função a atualização dos dados
      ...
      deleteTimer(mac, timer) {
        this.timerRef = this.db.object("/users/".concat(this.user.email, "/devices/").concat(mac, "/timer/").concat(timer));
    ...
    TimerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"]])], TimerService);
    /***/
  }
}]);
