...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-app mode=\"ios\">\r\n  <ion-router-outlet></ion-router-outlet>\r\n</ion-app>");
...
const routes = [
    ...
    // Essa rota recebe o id passado em seu page.ts para redirecinar o usuário para a página de edição de certo dispositivo
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-edit-device-edit-device-page-edit-device-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-device-edit-device-page-edit-device-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/device/edit-device-page/edit-device-page.module */ "./src/app/pages/edit/device/edit-device-page/edit-device-page.module.ts")).then(m => m.EditDevicePagePageModule),
    ...
    {
        path: 'verify-email',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-auth-verify-email-verify-email-module */ "pages-auth-verify-email-verify-email-module").then(__webpack_require__.bind(null, /*! ./pages/auth/verify-email/verify-email.module */ "./src/app/pages/auth/verify-email/verify-email.module.ts")).then(m => m.VerifyEmailPageModule)
    },
    // Rota 'signup'
    // Essa rota não recebe o canActive para que mesmo sem login ela seja acessivel
    {
        path: 'signup',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-auth-signup-signup-module */ "pages-auth-signup-signup-module").then(__webpack_require__.bind(null, /*! ./pages/auth/signup/signup.module */ "./src/app/pages/auth/signup/signup.module.ts")).then(m => m.SignupPageModule)
    },
    {
        path: 'menu',
    ...
    {
        path: 'edit-icons/:mac',
        loadChildren: () => Promise.all(/*! import() | pages-edit-device-edit-icons-edit-icons-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-device-edit-icons-edit-icons-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/device/edit-icons/edit-icons.module */ "./src/app/pages/edit/device/edit-icons/edit-icons.module.ts")).then(m => m.EditIconsPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'edit-rooms/:mac',
        loadChildren: () => Promise.all(/*! import() | pages-edit-device-edit-rooms-edit-rooms-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-device-edit-rooms-edit-rooms-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/device/edit-rooms/edit-rooms.module */ "./src/app/pages/edit/device/edit-rooms/edit-rooms.module.ts")).then(m => m.EditRoomsPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'edit-icon-room/:room',
        loadChildren: () => Promise.all(/*! import() | pages-edit-room-edit-icon-room-edit-icon-room-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-room-edit-icon-room-edit-icon-room-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/room/edit-icon-room/edit-icon-room.module */ "./src/app/pages/edit/room/edit-icon-room/edit-icon-room.module.ts")).then(m => m.EditIconRoomPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'edit-room-page/:room',
        loadChildren: () => Promise.all(/*! import() | pages-edit-room-edit-room-page-edit-room-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-room-edit-room-page-edit-room-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/room/edit-room-page/edit-room-page.module */ "./src/app/pages/edit/room/edit-room-page/edit-room-page.module.ts")).then(m => m.EditRoomPagePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'edit-timer-list/:mac',
        loadChildren: () => Promise.all(/*! import() | pages-functions-timer-edit-timer-list-edit-timer-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-functions-timer-edit-timer-list-edit-timer-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/functions/timer/edit-timer-list/edit-timer-list.module */ "./src/app/pages/functions/timer/edit-timer-list/edit-timer-list.module.ts")).then(m => m.EditTimerListPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'edit-timer-page/:mac/:timer',
        loadChildren: () => Promise.all(/*! import() | pages-functions-timer-edit-timer-page-edit-timer-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-functions-timer-edit-timer-page-edit-timer-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/functions/timer/edit-timer-page/edit-timer-page.module */ "./src/app/pages/functions/timer/edit-timer-page/edit-timer-page.module.ts")).then(m => m.EditTimerPagePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'add-timer-page/:mac',
        loadChildren: () => Promise.all(/*! import() | pages-functions-timer-add-timer-page-add-timer-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-functions-timer-add-timer-page-add-timer-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/functions/timer/add-timer-page/add-timer-page.module */ "./src/app/pages/functions/timer/add-timer-page/add-timer-page.module.ts")).then(m => m.AddTimerPagePageModule)
    },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_13__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].production })
        ],
        providers: [
...
let AuthenticationService = class AuthenticationService {
    constructor(ngFireAuth, router, ngZone, db) {
...
module.exports = __webpack_require__(/*! C:\Ionic\AppTCC\src\main.ts */"./src/main.ts");
