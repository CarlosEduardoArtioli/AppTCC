...
const routes = [
    ...
    {
        path: 'adicionar',
        loadChildren: () => Promise.all(/*! import() | pages-adicionar-adicionar-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-adicionar-adicionar-module")]).then(__webpack_require__.bind(null, /*! ./pages/adicionar/adicionar.module */ "./src/app/pages/adicionar/adicionar.module.ts")).then(m => m.AdicionarPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    // Rota 'edit-device-list'
    {
        path: 'edit-device-list',
        loadChildren: () => Promise.all(/*! import() | pages-edit-edit-device-list-edit-device-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-edit-device-list-edit-device-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/edit-device-list/edit-device-list.module */ "./src/app/pages/edit/edit-device-list/edit-device-list.module.ts")).then(m => m.EditDeviceListPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    ...
    // Essa rota recebe o id passado em seu page.ts para redirecinar o usuário para a página de edição de certo dispositivo
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-edit-edit-device-page-edit-device-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-edit-device-page-edit-device-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit/edit-device-page/edit-device-page.module */ "./src/app/pages/edit/edit-device-page/edit-device-page.module.ts")).then(m => m.EditDevicePagePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    // Rota 'login'
    ...
    {
        path: 'functions',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-functions-functions-module */ "pages-functions-functions-module").then(__webpack_require__.bind(null, /*! ./pages/functions/functions.module */ "./src/app/pages/functions/functions.module.ts")).then(m => m.FunctionsPageModule)
    },
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_14__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].production })
        ],
        providers: [
