(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!--\r\n  Tudo que é colocado nessa página aparece no app inteiro\r\n  Nesse caso temos um side menu\r\n-->\r\n\r\n<ion-app>\r\n  <ion-menu side=\"start\" menuId=\"first\" contentId=\"content1\" *ngIf=\"showComponent\">\r\n    <ion-header>\r\n      <ion-toolbar>\r\n        <ion-item (click)=\"showOptions()\" lines=\"none\">\r\n          <ion-avatar slot=\"start\">\r\n            <img src=\"{{user.image}}\">\r\n          </ion-avatar>\r\n          <ion-label>{{user.name}}</ion-label>\r\n        </ion-item>\r\n      </ion-toolbar>\r\n    </ion-header>\r\n    <ion-content>\r\n      <ion-list *ngFor=\"let page of pages\" lines=\"none\">\r\n        <ion-menu-toggle auto-hide=\"true\">\r\n          <ion-item [routerLink]=\"page.url\" routerDirection=\"forward\">\r\n            <ion-icon [name]=\"page.icon\" slot=\"start\"></ion-icon>\r\n            {{page.title}}\r\n          </ion-item>\r\n        </ion-menu-toggle>\r\n      </ion-list>\r\n    </ion-content>\r\n  </ion-menu>\r\n  <ion-router-outlet id=\"content1\"></ion-router-outlet>\r\n</ion-app>";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./guards/auth.guard */
    "./src/app/guards/auth.guard.ts"); // Importação da classe AuthGuard
    // Rotas do App


    const routes = [// Caso a rota seja nula o app redireciona para a página 'login' 
    {
      path: '',
      redirectTo: 'login',
      pathMatch: 'full'
    ...
    // Assim evitando que o usuário entre no em certas páginas sem o login
    {
      ...
      "./src/app/pages/home/home.module.ts")).then(m => m.HomePageModule),
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, // Rota 'adicionar'
    {
      path: 'adicionar',
      loadChildren: () => Promise.all(
      /*! import() | pages-adicionar-adicionar-module */
      [__webpack_require__.e("common"), __webpack_require__.e("pages-adicionar-adicionar-module")]).then(__webpack_require__.bind(null,
      /*! ./pages/adicionar/adicionar.module */
      "./src/app/pages/adicionar/adicionar.module.ts")).then(m => m.AdicionarPageModule),
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, // Rota 'edit-device-list'
    {
      path: 'edit-device-list',
      loadChildren: () => Promise.all(
      /*! import() | pages-edit-edit-device-list-edit-device-list-module */
      [__webpack_require__.e("common"), __webpack_require__.e("pages-edit-edit-device-list-edit-device-list-module")]).then(__webpack_require__.bind(null,
      /*! ./pages/edit/edit-device-list/edit-device-list.module */
      "./src/app/pages/edit/edit-device-list/edit-device-list.module.ts")).then(m => m.EditDeviceListPageModule),
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    ...
    // Essa rota recebe o id passado em seu page.ts para redirecinar o usuário para a página de edição de certo dispositivo
    {
      ...
      loadChildren: () => Promise.all(
      /*! import() | pages-edit-edit-device-page-edit-device-page-module */
      [__webpack_require__.e("common"), __webpack_require__.e("pages-edit-edit-device-page-edit-device-page-module")]).then(__webpack_require__.bind(null,
      /*! ./pages/edit/edit-device-page/edit-device-page.module */
      "./src/app/pages/edit/edit-device-page/edit-device-page.module.ts")).then(m => m.EditDevicePagePageModule),
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, // Rota 'login'
    // Essa rota não recebe o canActive para que mesmo sem login ela seja acessivel
    {
      ...
      "./src/app/pages/auth/login/login.module.ts")).then(m => m.LoginPageModule)
    }, // Rota 'signup'
    // Essa rota não recebe o canActive para que mesmo sem login ela seja acessivel
    {
      path: 'signup',
      ...
      "./src/app/pages/auth/signup/signup.module.ts")).then(m => m.SignupPageModule)
    }, {
      path: 'functions',
      loadChildren: () => __webpack_require__.e(
      /*! import() | pages-functions-functions-module */
      "pages-functions-functions-module").then(__webpack_require__.bind(null,
      /*! ./pages/functions/functions.module */
      "./src/app/pages/functions/functions.module.ts")).then(m => m.FunctionsPageModule)
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@ionic-native/Camera/ngx/index.js"); // Importação do Model do usuário


    let AppComponent = class AppComponent {
      constructor(platform, navCtrl, actionSheetCtrl, router, alertCtrl, imagePicker, file, camera) {
        ...
        this.file = file;
        this.camera = camera; // Variável user
      ...
      initializeApp() {
        this.platform.ready().then(() => {
          ...
          this.sideMenu(); // Atribui a variável user o usuário logado no app
      ...
      pickImage(sourceType) {
        ...
        this.camera.getPicture(options).then(imageData => {// imageData is either a base64 encoded string or a file URI
            ...
            buttons: [{
              ...
              handler: data => {
                ...
                if (document.getElementById('newname').value != "") {
                  ...
                  localStorage.setItem('app.user', JSON.stringify(new _models_user_model__WEBPACK_IMPORTED_MODULE_3__["User"](this.novoNome, this.user.email, this.user.image)));
                  this.newname();
                  this.user = JSON.parse(localStorage.getItem('app.user'));
                }
              }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ActionSheetController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_native_image_picker_ngx__WEBPACK_IMPORTED_MODULE_5__["ImagePicker"], _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_6__["File"], _ionic_native_Camera_ngx__WEBPACK_IMPORTED_MODULE_7__["Camera"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    /*! @ionic-native/Camera/ngx */
    "./node_modules/@ionic-native/Camera/ngx/index.js"); // Aqui é onde são declarados "Bibliotecas" que vão ser usadas no app 
    // Mas não são todas
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_7__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].firebaseConfig), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_8__["AngularFireAuthModule"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_9__["AngularFireDatabaseModule"], _angular_fire_storage__WEBPACK_IMPORTED_MODULE_10__["AngularFireStorageModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_14__["ServiceWorkerModule"].register('ngsw-worker.js', {
        enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].production
      })],
      providers: [_ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_12__["Keyboard"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"], {
        provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"],
        useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"]
      }, _ionic_native_image_picker_ngx__WEBPACK_IMPORTED_MODULE_15__["ImagePicker"], _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_16__["File"], _ionic_native_Camera_ngx__WEBPACK_IMPORTED_MODULE_17__["Camera"]],
  ...
  function srcAppGuardsAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @ionic/angular */
    "./node_modules/@ionic/angular/fesm2015/ionic-angular.js"); // O auth.guard.ts serve para verificar se o usuário está autenticado
    ...
    let AuthGuard = class AuthGuard {
      constructor( // NavController é uma classe para o controle da navegação dentro do App
      ...
      canActivate() {
        ...
        const user = localStorage.getItem('app.user'); // Se não houver usuário logado

        if (!user) {
          // Redireciona para a pagina 'login'
          this.navCtrl.navigateRoot('login'); // Retorna para a função o valor 'false'
    ...
    AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]])], AuthGuard);
    /***/
  },
  ...
  function srcAppModelsUserModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! tslib */
    "./node_modules/tslib/tslib.es6.js"); // Model dos dados do usuário
