(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-auth-login-login-module"], {
  ...
  function srcAppPagesAuthLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let LoginPage = class LoginPage {
      ...
      verificaUser() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          this.user = JSON.parse(localStorage.getItem('app.user')); // Se o usuário for diferente de nulo
          ...
          if (this.user != null) {
            ...
            loading.present(); // Navega para a página 'home'

            this.navCtrl.navigateRoot('home'); // Função que retira a mensagem de "Autenticando..."
      ...
      submit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          loading.present(); // Função que faz o login com email e senha, ela pega os valores do HTML

          this.fbAuth.auth.signInWithEmailAndPassword(this.form.controls['email'].value, this.form.controls['password'].value) // Quando pega os dados
          .then(data => {
            // Função que retira a mensagem de "Autenticando..."
            loading.dismiss(); // Entra no local storage e "seta" o item 'app.user' com um JSON com os valores recebidos 

            localStorage.setItem('app.user', JSON.stringify(new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_6__["User"]('', data.user.email, ''))); // Navega para a página 'home'

            this.navCtrl.navigateRoot('home');
          }) // Caso ocorra erro
          .catch(err => {
            // Escreve no console a mensagem de erro
            console.log(err); // Função que retira a mensagem de "Autenticando..."

            loading.dismiss(); // Chama a função 'showMessage()' e passa o parâmetro "Usuário ou senha inválidos"
      ...
      signInWithGoogle() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          this.fbAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].GoogleAuthProvider()) // Quando pega os dados
          .then(data => {
            // Escreve no console os dados
            console.log(data); // "Seta" no local storage um item com o nome 'app.user' com um JSON com os valores recebidos 

            localStorage.setItem('app.user', JSON.stringify(new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_6__["User"](data.user.displayName, data.user.email, data.user.photoURL))); // Chama a função 'showMessage()' e passa o parâmetro "Fazendo Login..."

            this.showMessage("Fazendo Login..."); // Navega para a página 'home'

            this.navCtrl.navigateRoot('home');
          }) // Caso ocorra erro
          .catch(err => {
            // Escreve no console a mensagem de erro
            console.log(err); // Chama a função 'showMessage()' e passa o parâmetro "Usuário ou senha inválidos"
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('myInput', {
      static: true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonInput"])], LoginPage.prototype, "myInput", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_4__["AngularFireAuth"], _ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_7__["Keyboard"]])], LoginPage);
    /***/
  }
}]);
